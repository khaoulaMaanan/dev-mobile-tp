...
class QuizzPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final _quizzpageCubit = context.read<QuizzpageCubit>();
    bool reponse=false;
    // TODO: implement build
    return BlocBuilder<QuizzpageCubit,QuizzpageInitial>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(_quizzpageCubit.questions[_quizzpageCubit.index].questionText,
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            if(_quizzpageCubit.questions[_quizzpageCubit.index].isCorrect==reponse){
                              _quizzpageCubit.incrementScore();
                              if(_quizzpageCubit.index < _quizzpageCubit.questions.length -1){
                                _quizzpageCubit.nextQuestion();
                              }else{
                              ...
                              _quizzpageCubit.decrementScore();
                              if(_quizzpageCubit.index < _quizzpageCubit.questions.length -1){
                                _quizzpageCubit.nextQuestion();
                              }else{
                                //Navigator.pushNamed(context, '/result');
                  ...
                  Container(
                    ...
                    child: Text("Score : ""${_quizzpageCubit.score}",
                      textAlign: TextAlign.center,
